<x-filament-companies::grid-section md="2">
    ...
    <x-slot name="description">
        {{ __('The company\'s details and owner information.') }}
    </x-slot>
    ...
    <x-filament::section>
        <x-filament-panels::form wire:submit="updateCompanyName">
            ...
            <!-- Company website -->
            <x-filament-forms::field-wrapper id="website" statePath="website" label="{{ __('Website') }}">
                <x-filament::input.wrapper class="overflow-hidden">
                    <x-filament::input id="website" type="text" maxlength="255" wire:model="state.website" :disabled="!Gate::check('update', $company)"/>
                </x-filament::input.wrapper>
            </x-filament-forms::field-wrapper>
